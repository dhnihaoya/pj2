...
function deletePic(btnId){
    ...
    document.cookie = "picToDelID="+ divId +"; expires="+expTime+"; path=/pj2/";
    xmlhttp.open("GET","/pj2/php/DeleteMypicAJAX.php",true);
    xmlhttp.send();
}
function modifyPic(btnId){
    var btn = $("#"+btnId);
    //也是图片id
    var divId = btn.attr('id').substr(3);
    var src = $('img','#'+divId).attr('src');
